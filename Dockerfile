...
# Adjust --strip-components if needed depending on the tar structure.
# If after running the image, Grype complains about the DB, try changing or removing --strip-components.
